...
export const products = ["사과주스", "포도주스", "오미자차", "블루베리잼", "사과잼", "건조과일", "채소분말", "앙금빵"];

export const processes: Array<[string, string, string[]]> = [
  ["과채주스", "사과주스 · 포도주스 · 혼합주스", ["원료입고", "세척·선별", "파쇄", "착즙", "여과", "살균", "충진", "포장·출고"]],
  ["액상차", "오미자차 · 허브진액", ["원료입고", "전처리", "계량", "추출", "여과", "농축", "살균", "충진·출고"]],
  ["잼류", "사과잼 · 블루베리잼", ["원료입고", "탈피·제심", "파쇄", "계량·혼합", "가열·농축", "충진", "후살균", "출고"]],
  ["분말류", "과채분말 · 곡물분말", ["원료입고", "세척", "절단", "건조", "분쇄", "이물선별", "내포장", "출고"]],
];
