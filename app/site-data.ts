...
export const products = ["블루베리쨈", "딸기쨈", "사과즙", "토마토즙", "토마토퓨레", "딸기블루베리잼", "사과잼"];
...
export const processes: ProcessItem[] = [
  { name: "블루베리쨈", category: "잼류", image: null, steps: ["원료입고", "세척·선별", "파쇄", "계량·혼합", "가열·농축", "충진", "후살균", "포장·출고"] },
  { name: "딸기쨈", category: "잼류", image: null, steps: ["원료입고", "세척·선별", "파쇄", "계량·혼합", "가열·농축", "충진", "후살균", "포장·출고"] },
  { name: "사과즙", category: "음료", image: null, steps: ["원료입고", "세척·선별", "파쇄", "착즙", "여과", "살균", "충진", "포장·출고"] },
  { name: "토마토즙", category: "음료", image: null, steps: ["원료입고", "세척·선별", "파쇄", "착즙", "여과", "살균", "충진", "포장·출고"] },
  { name: "토마토퓨레", category: "퓨레", image: null, steps: ["원료입고", "세척·선별", "파쇄", "가열", "농축", "충진", "후살균", "포장·출고"] },
  { name: "딸기블루베리잼", category: "잼류", image: null, steps: ["원료입고", "세척·선별", "파쇄", "계량·혼합", "가열·농축", "충진", "후살균", "포장·출고"] },
  { name: "사과잼", category: "잼류", image: null, steps: ["원료입고", "세척·선별", "탈피·제심", "파쇄", "계량·혼합", "가열·농축", "충진", "포장·출고"] },
];
